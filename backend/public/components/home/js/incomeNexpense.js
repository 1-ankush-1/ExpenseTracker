...
async function getDataByDay(e) {
    ...
    try {
        ...
        if (dateDetails.day) {
            timeslot = null;
            const monthdata = await axios.get(`34.229.6.78:3000/premium/report/day/${dateDetails.day}`, {
                headers: {
            ...
            const monthdata = await axios.get(`34.229.6.78:3000/premium/report/month/${dateDetails.month}`, {
                headers: {
                    Authorization: usertoken
                }
            });
            ...
            const yeardata = await axios.get(`34.229.6.78:3000/premium/report/year/${dateDetails.year}`, {
                headers: {
                    Authorization: usertoken
                }
            });
...
async function handelDownloadFile(e) {
    ...
    try {
        if (timespan && timeslot) {
            const response = await axios.get(`34.229.6.78:3000/premium/report/download?filetype=${timespan}&timeslot=${timeslot}`, {
                headers: {
                    Authorization: usertoken
                }
            })
