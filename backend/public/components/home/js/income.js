...
async function onloadData() {
    ...
    try {
        ...
        //get data
        const incomes = await axios.get(`http://34.229.6.78:4000/income`, {
            headers: {
...
function AddIncomeForm(e) {
    ...
    axios.post("http://34.229.6.78:4000/income/add", incomeDataTosend, {
        headers: {
            Authorization: usertoken
        }
    }).then((res) => {
...
function removeChild(row) {
    ...
    axios.delete(`http://34.229.6.78:4000/income/delete/${row.id}`, {
        headers: {
            Authorization: usertoken
        }
    }).then((res) => {
